...
//     .goreleaser.yaml and GOAL.md §18.
...
// These are overwritten at link time by GoReleaser. package main wires the
// ldflags vars (GOAL.md §18) into Set before any command runs. Defaults make a
// plain `go run` honest about being a dev build.
var (
	version = "dev"
	commit  = "none"
	date    = "unknown"
...
// contract in GOAL.md §6: {"version","commit","date","go"}.
type Build struct {
