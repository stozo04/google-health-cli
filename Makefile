# google-health-cli — common developer tasks.
# Run `make help` for the list. Recipes use tabs (Make requirement).

BINARY       := google-health-cli
PKG          := ./...
MAIN         := ./cmd/google-health-cli
LOCAL_PREFIX := github.com/stozo04/google-health-cli
...
.PHONY: check-agents
check-agents: ## Check complete project skill mirrors
